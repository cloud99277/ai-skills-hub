...
description: Markdown-to-HTML rendering workflow for WeChat and similar publishing targets, with support for code highlighting, math, alerts, footnotes, and PlantUML. Use when you need styled HTML from Markdown for publishing. Prefer `baoyu-format-markdown` for messy source content, and prefer `baoyu-post-to-wechat` for direct WeChat publishing.
---
