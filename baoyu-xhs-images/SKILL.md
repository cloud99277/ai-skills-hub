...
description: Generates a Xiaohongshu or RedNote multi-image card series from content, typically including a cover and follow-up content cards, with platform-native styles and layouts optimized for feed sharing. Use when the user wants 小红书图片, RedNote carousel cards, or a social post image series, not a single infographic, article cover, comic, or generic image.
---
