...
description: Write or refine a single polished long-form asset such as an article, guide, tutorial, essay, or newsletter issue with a specific voice or brand style. Use when the user wants 长文写作, 博客或教程创作, or a standalone long-form piece, not social posts, threads, or multi-platform repurposing.
---
