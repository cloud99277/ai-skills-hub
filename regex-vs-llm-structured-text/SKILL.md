...
description: Decision framework for choosing between regex and an LLM when parsing structured text. Use when extracting fields from semi-structured content and you need to decide whether simple deterministic parsing is enough or whether an LLM is justified for messy edge cases.
---
