...
description: Generates standalone images or image edits from prompts or reference images, with controllable provider, model, and aspect ratio. Use when the user needs generic image generation and has not requested a specialized output such as a cover image, article illustration set, infographic, comic, Xiaohongshu image series, or slide deck visual.
---
