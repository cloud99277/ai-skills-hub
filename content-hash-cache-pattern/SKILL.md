...
description: Cache expensive file-processing results using SHA-256 content hashes so repeated runs can reuse work and invalidate automatically when content changes. Use when the user needs faster repeated processing of files such as parsing, OCR, transcription, or transformation pipelines.
---
