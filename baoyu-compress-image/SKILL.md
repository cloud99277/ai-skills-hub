...
description: Compresses existing local images or image directories into smaller WebP, PNG, or JPEG outputs with automatic tool selection. Use when the goal is file-size optimization or format conversion, not image generation, illustration design, or platform publishing.
---
